# Contributing to PDFBay

First off, thank you for considering contributing to **PDFBay**! Your help makes this project better for everyone.
...
Before we can accept your contributions, you must sign our Contributor License Agreement (CLA). This is required because PDFBay uses a dual licensing model:
...
If you are contributing on behalf of your employer, your organization needs to sign our [Corporate Contributor License Agreement (CCLA)](CCLA.md). Please contact us at [contact@pdfbay.pages.dev](mailto:contact@pdfbay.pages.dev) to arrange corporate CLA signing.
...
**Email:** [contact@pdfbay.pages.dev](mailto:contact@pdfbay.pages.dev)
...
Thank you for helping make **PDFBay** a better library for everyone!
